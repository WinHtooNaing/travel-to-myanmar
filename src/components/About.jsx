...
const About = () => {
    return (
        ...
        <img src="https://images.unsplash.com/photo-1576239474622-286656a6a38b?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=870&q=80" alt="heroImg" />
        
        </div>


        <div className="about-container">
            <h1>About Our Country</h1>
            <p>Myanmar, officially the Republic of the Union of Myanmar, 
                also known as Burma (the official name until 1989),
                 is a country in Southeast Asia. It is the largest country
                  by area in Mainland Southeast Asia, and had a population
                   of about 54 million in 2017.
                 It is bordered by Bangladesh and India to its northwest,
                  China to its northeast, Laos and Thailand to its east and southeast, 
                  and the Andaman Sea and the Bay of Bengal to its south and southwest.
                   ...
                   Early civilisations in the area included the Tibeto-Burman-speaking Pyu city-states
                    in Upper Myanmar and the Mon kingdoms in Lower Myanmar.
                     In the 9th century, the Bamar people entered the upper Irrawaddy
                      valley, and following the establishment of the Pagan Kingdom in 
                      the 1050s, the Burmese language, culture, and Theravada Buddhism 
                      slowly became dominant in the country. The Pagan Kingdom fell to Mongol
                       invasions, and several warring states emerged. In the 16th century, reunified 
...
Myanmar is a member of the East Asia Summit, Non-Aligned Movement, ASEAN, and BIMSTEC, but it is not a member of the Commonwealth of Nations despite once being part of the British Empire. The country is very rich in natural resources, such as jade, gems, oil, natural gas, teak and other minerals, as well as also endowed with renewable energy, having the highest solar power potential compared to other countries of the Great Mekong Subregion. However, Myanmar has long suffered from instability, factional violence, corruption, poor infrastructure, as well as a long history of colonial exploitation with little regard to human development. In 2013, its GDP (nominal) stood at US$56.7 billion and its GDP (PPP) at US$221.5 billion. The income gap in Myanmar is among the widest in the world, as a large proportion of the economy is controlled by cronies of the military junta. Myanmar is one of the least developed countries; as of 2020, according to the Human Development Index, it ranks 147 out of 189 countries in terms of human development.

 Since 2021, more than 600,000 people were displaced across Myanmar 
 due to the surge in violence post-coup, with more than 3 million people
  in dire need of humanitarian assistance.
</p>
<h1>Vision & Mission</h1>
<p>
To be leading DMC and service provider in region.<br/>
We are a professional DMC that delivers personalized services based on robust local knowledge with a strong understanding of the global market.
Myanmar Voyages offers curated tours and valued services ensuring travelers’ safety and satisfaction throughout their whole trip. We make sure our programs respect the local cultural
 and social values and comply with our commitment to sustainability.
</p>
